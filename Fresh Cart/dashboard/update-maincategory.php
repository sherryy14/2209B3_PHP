...
$fetch = "SELECT * FROM `parent_category` WHERE pc_id = $id";
...
if(isset($_POST['submit'])){
    ...
    $update = "UPDATE `parent_category` SET `pc_name` = '{$name}' , `img` = '{$img_name}' WHERE `pc_id` = '{$u_id}'";
                        ...
                        <div class="col-lg-12 col-12">
                            ...
                            <div class="card mb-6 shadow border-0">
                                <form  method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value='<?php echo $row['pc_id']?>'>
                                <!-- card body -->
                                <div class="card-body p-6 ">
                                    <h4 class="mb-5 h5">Category Image</h4>
                                    <div class="mb-4 d-flex">
                                        <div class="position-relative" >
                                            <img class="image  icon-shape icon-xxxl bg-light rounded-4"  src="../assets/images/icons/<?php echo $row['img']?>" alt="Image">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="cat_name" placeholder="Category Name" value="<?php echo $row['pc_name']?>"
                                                required>
                                        </div>
