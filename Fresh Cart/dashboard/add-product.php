                        ...
                        <div class="card-body p-6 ">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-12 mt-5">
                                    ...
                                    <textarea name="description" cols="30" rows="10" class="form-control" placeholder='Write description'></textarea>
                        ...
                        <div class="card-body p-6">
                            ...
                            <div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="code" placeholder="Enter Product Title">
                                </div>
                                <!-- input -->
                                <div class="mb-3">
                                    <label class="form-label">Product Dimension</label>
                                    <input type="text" class="form-control" name="dimension" placeholder="Enter Product Title">
                                </div>
                                <!-- input -->
                                <div class="mb-3">
