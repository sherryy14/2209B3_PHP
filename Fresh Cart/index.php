  ...
  <section class="my-lg-14 my-8">
    <div class="container">
      ...
      <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3">
        ...
        <?php
        $fetch = "SELECT * FROM `products` AS p INNER JOIN `sub_category` AS sc ON p.category = sc.sc_id INNER JOIN `parent_category` AS pc ON sc.sc_category = pc.pc_id";
        ...
        ?>
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="#!"> <img src="assets/images/products/<?php echo $row['img1'] ?>" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>

                  <div class="card-product-action">
                    <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal<?php echo $row['id'] ?>"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i></a>
                ...
                <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small><?php echo $row['pc_name'] ?></small></a></div>
                <h2 class="fs-6"><a href="pages/shop-single.php?id=<?php echo $row['id'] ?>" class="text-inherit text-decoration-none"><?php echo $row['title'] ?></a></h2>
                <div>
          ...
          <!-- Modal -->
          <div class="modal fade" id="quickViewModal<?php echo $row['id'] ?>" tabindex="-1" aria-hidden="true">
                  ...
                  ">
                    ...
                    <div class="col-lg-6">
                      <div class="ps-lg-8 mt-6 mt-lg-0">
                        <a href="#!" class="mb-4 d-block"><?php echo $row['pc_name']?></a>
                        <h2 class="mb-1 h1"><?php echo $row['title']?></h2>
                        <div class="mb-4">
